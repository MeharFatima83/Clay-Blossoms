...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_API}/api/users/authenticate`, {
        method: 'POST',
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/user-signup" className="font-medium text-orange-600 hover:text-orange-500 transition-colors duration-200">
                Sign up
              </Link>
            </p>
          </div>
